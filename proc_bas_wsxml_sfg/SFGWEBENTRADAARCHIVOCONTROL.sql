USE SFGPRODU;
--  DDL for Package Body SFGWEBENTRADAARCHIVOCONTROL
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL */ 

-- Creates a new record in the ENTRADAARCHIVOCONTROL table
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecord(
    @pk_ID_ENTRADAARCHIVOCONTROL NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetRecord(
   @pk_ID_ENTRADAARCHIVOCONTROL NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_DrillDown(
...
-- Returns a query result from table ENTRADAARCHIVOCONTROL
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBENTRADAARCHIVOCONTROL_Export(
