...
CREATE  PROCEDURE WSXML_SFG.SFGCICLOFACTURACIONPDV_GetTerminatedCycle(@p_FECHAEJECUCION DATETIME, @p_TERMINATED NUMERIC(22,0) OUT, @p_ERRORMESSAGE NVARCHAR(2000)) AS
 BEGIN
