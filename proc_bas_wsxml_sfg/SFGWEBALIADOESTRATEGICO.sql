USE SFGPRODU;
--  DDL for Package Body SFGWEBALIADOESTRATEGICO
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGWEBALIADOESTRATEGICO */ 

-- Creates a new record in the ALIADOESTRATEGICO table
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecord(
    @pk_ID_ALIADOESTRATEGICO NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetRecord(
   @pk_ID_ALIADOESTRATEGICO NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_DrillDown(
...
-- Returns a query result from table ALIADOESTRATEGICO
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBALIADOESTRATEGICO_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBALIADOESTRATEGICO_Export(
...
SET NOCOUNT ON;
    ...
    BEGIN
        SET @l_title_str =
                ...
                'CODUSUARIOGERENTECUENTA NOMBRE' + isnull(@p_separator_str, '') +
                'EMAILCONTACTO' + ' ''';
    END 
    ...
    BEGIN
        SET @l_select_str =
                ...
                ''''' + REPLACE( isnull( t3.NOMBRE, ''''), '''', '''') + ''''  + ''' + isnull(@p_separator_str, '') + ''' +' +
                ''''' + REPLACE( isnull(ALIADOESTRATEGICO_.EMAILCONTACTO, ''''), '''', '''') + ''''  + '' ''';
    END 

    -- Set up the from string (with table alias) and the join string
    SET @l_from_str = 'WSXML_SFG.ALIADOESTRATEGICO ALIADOESTRATEGICO_ LEFT OUTER JOIN WSXML_SFG.USUARIO t0 ON (ALIADOESTRATEGICO_.CODUSUARIOMODIFICACION =  t0.ID_USUARIO) LEFT OUTER JOIN WSXML_SFG.CIUDAD t1 ON (ALIADOESTRATEGICO_.CODCIUDAD =  t1.ID_CIUDAD) LEFT OUTER JOIN WSXML_SFG.REGIMEN t2 ON (ALIADOESTRATEGICO_.CODREGIMEN =  t2.ID_REGIMEN) LEFT OUTER JOIN WSXML_SFG.USUARIO t3 ON (ALIADOESTRATEGICO_.CODUSUARIOGERENTECUENTA =  t3.NOMUSUARIO)';
