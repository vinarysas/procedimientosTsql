USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBENTRADACONCILIACIPR
--------------------------------------------------------

  /* PACKAGE BODY SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR */ 

-- Creates a new record in the ENTRADACONCILIACIPR table
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_AddRecord;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_AddRecord(
...
SET NOCOUNT ON;
    INSERT
    INTO SFG_CONCILIACION.ENTRADACONCILIACIPR
        (
            CIT_03_REC_TYPE,
            CIT_03_BUS_DATE,
            CIT_03_TRML_NMBR,
...
-- Updates a record in the ENTRADACONCILIACIPR table.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_UpdateRecord;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_UpdateRecord(
...
SET NOCOUNT ON;
    ...
    UPDATE SFG_CONCILIACION.ENTRADACONCILIACIPR
    SET
...
-- Deletes a record from the ENTRADACONCILIACIPR table.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecord;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecord(
    @pk_ID_ENTRADACONCILIACITI NUMERIC(22,0)
    )
AS
BEGIN
SET NOCOUNT ON;
    DELETE SFG_CONCILIACION.ENTRADACONCILIACIPR
    WHERE ID_ENTRADACONCILIACITI = @pk_ID_ENTRADACONCILIACITI;
END;
GO

-- Deletes the set of rows from the ENTRADACONCILIACIPR table
-- that match the specified search criteria.
-- Returns the number of rows deleted as an output parameter.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecords;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DeleteRecords(
...
-- Returns a specific record from the ENTRADACONCILIACIPR table.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetRecord;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetRecord(
   @pk_ID_ENTRADACONCILIACITI NUMERIC(22,0)
...
SET NOCOUNT ON;
    ...
    FROM SFG_CONCILIACION.ENTRADACONCILIACIPR
    WHERE ID_ENTRADACONCILIACITI = @pk_ID_ENTRADACONCILIACITI;
...
-- Returns a query resultset from table ENTRADACONCILIACIPR
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetList', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetList;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetList(
...
SET NOCOUNT ON;
    ...
    SET @l_from_str = 'SFG_CONCILIACION.ENTRADACONCILIACIPR ENTRADACONCILIACITI_';
...
-- Returns a query result from table ENTRADACONCILIACIPR
-- given the search criteria and sorting condition.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DrillDown;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_DrillDown(
...
-- Returns a query result from table ENTRADACONCILIACIPR
-- given the search criteria and sorting condition.
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetStats;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_Export', 'P') IS NOT NULL
  DROP PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_Export;
GO

CREATE PROCEDURE SFG_CONCILIACION.SFGCONCIWEBENTRADACONCILIACIPR_Export(
...
SET NOCOUNT ON;
    ...
    SET @l_from_str = 'SFG_CONCILIACION.ENTRADACONCILIACIPR ENTRADACONCILIACITI_ LEFT OUTER JOIN SFG_CONCILIACION.ENTRADACONCILIAALI t0 ON (ENTRADACONCILIACITI_.CODENTRADACONCILIAALI =  t0.ID_ENTRADACONCILIAALI)';
