USE SFGPRODU;
--  DDL for Package Body SFGWEBREGISTROFACTURACION
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGWEBREGISTROFACTURACION */ 

-- Creates a new record in the REGISTROFACTURACION table
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecord(
    @pk_ID_REGISTROFACTURACION NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetRecord(
   @pk_ID_REGISTROFACTURACION NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_DrillDown(
...
-- Returns a query result from table REGISTROFACTURACION
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBREGISTROFACTURACION_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBREGISTROFACTURACION_Export(
