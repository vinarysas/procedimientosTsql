USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBRANGOCOMISION
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGCONCIWEBRANGOCOMISION */ 

-- Creates a new record in the RANGOCOMISION table
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecord(
    @pk_ID_RANGOCOMISION NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetRecord(
   @pk_ID_RANGOCOMISION NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_DrillDown(
...
-- Returns a query result from table RANGOCOMISION
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBRANGOCOMISION_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBRANGOCOMISION_Export(
...
SET NOCOUNT ON;
    ...
    BEGIN
        SET @l_select_str =
                ...
                ''''' + REPLACE( isnull( t1.NOMTIPORANGO, ''''), '''', '''') + ''''  + ''' + isnull(@p_separator_str, '') + ''' +' +
    ...
    SET @l_from_str = 'WSXML_SFG.RANGOCOMISION RANGOCOMISION_ LEFT OUTER JOIN WSXML_SFG.TIPOCOMISION t0 ON (RANGOCOMISION_.CODTIPOCOMISION =  t0.ID_TIPOCOMISION) LEFT OUTER JOIN WSXML_SFG.TIPORANGO t1 ON (RANGOCOMISION_.CODTIPORANGO =  t1.ID_TIPORANGO)';
