 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    BEGIN
      ...
      WHERE CODPRODUCTOCONTRATOCOMDIFTARIF = @cCODPRODUCTOCONTCOMDIFTARIFA AND CODTARIFAVALOR = @p_CODTARIFAVALOR AND FECHAINICIOVALIDEZ = @cFECHA;
...
CREATE     PROCEDURE WSXML_SFG.SFGPRODUCTOCONTRATO_SetTipoContrato(@p_CODPRODUCTO             NUMERIC(22,0), 
  ...
  SET NOCOUNT ON;
    ...
    WHERE ID_PRODUCTOCONTRATO = @p_ID_PRODUCTOCONTRATO_out;
	IF @@ROWCOUNT = 0 BEGIN
		--RAISE_APPLICATION_ERROR(-20054, 'No se puede actualizar el tipo de contrato a un contrato no existente');
