  ...
  SET NOCOUNT ON;
    ...
    BEGIN
		...
		BEGIN CATCH
			...
			EXEC WSXML_SFG.SFGFACTURACIONLINEADENEGOCIO_AddRecord @p_CODLINEADENEGOCIO,
				@p_CODPERIODICIDAD, @p_FECHA, @p_CODUSUARIOMODIFICACION, @cCODFACTURACIONLINEADENEGOCIO OUT;
		...
		BEGIN
			BEGIN TRY
				...
				IF @thCODFACTURACIONLINEADENEGOCIO <> @cCODFACTURACIONLINEADENEGOCIO BEGIN
					...
					EXEC WSXML_SFG.SFGPUNTODEVENTAFACTURACION_AddRecord @p_CODPUNTODEVENTA, @cCODFACTURACIONLINEADENEGOCIO, @p_CODUSUARIOMODIFICACION, @p_ID_PDVFACTURACION_out OUT
				END 
    ...
    ELSE BEGIN
      EXEC WSXML_SFG.SFGPUNTODEVENTAFACTURACION_AddRecord @p_CODPUNTODEVENTA,
                @cCODFACTURACIONLINEADENEGOCIO, @p_CODUSUARIOMODIFICACION, @p_ID_PDVFACTURACION_out OUT;
    END 
  END;
GO
