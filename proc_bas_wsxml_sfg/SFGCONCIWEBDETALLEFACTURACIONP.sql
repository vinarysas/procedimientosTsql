USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBDETALLEFACTURACIONP
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP */ 

-- Creates a new record in the DETALLEFACTURACIONPDV table
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecord(
    @pk_ID_DETALLEFACTURACIONPDV NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetRecord(
   @pk_ID_DETALLEFACTURACIONPDV NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_DrillDown(
...
-- Returns a query result from table DETALLEFACTURACIONPDV
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBDETALLEFACTURACIONP_Export(
