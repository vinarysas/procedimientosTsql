USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBPUNTODEVENTA
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGCONCIWEBPUNTODEVENTA */ 

-- Creates a new record in the PUNTODEVENTA table
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_UpdateRecord(
        @p_ID_PUNTODEVENTA NUMERIC(22,0),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecord(
    @pk_ID_PUNTODEVENTA NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetRecord(
   @pk_ID_PUNTODEVENTA NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_DrillDown(
...
-- Returns a query result from table PUNTODEVENTA
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBPUNTODEVENTA_Export(
