 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    BEGIN
      ...
      UPDATE WSXML_SFG.PRODCONTRATOESTANDARHISTORICO SET CODRANGOCOMISIONESTANDAR = @p_CODRANGOCOMISIONESTANDAR WHERE ID_PRODCONTRATOESTANDARHISTORI = @cCODPRODCONTRATOESTANDARHST;
