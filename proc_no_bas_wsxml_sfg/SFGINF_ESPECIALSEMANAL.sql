...
CREATE     PROCEDURE WSXML_SFG.SFGINF_ESPECIALSEMANAL_EfectySemanal(@ID_DETALLETAREAEJECUTADA NUMERIC(22,0),
                      @DIA                      DATETIME) AS
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    SET @sFECHALAST=@sFECHAFRST + 6 ;
      ...
      SELECT NOMPRODUCTO,
       ...
       INNER JOIN WSXML_SFG.WSXML_SFG.ENTRADAARCHIVOCONTROL
