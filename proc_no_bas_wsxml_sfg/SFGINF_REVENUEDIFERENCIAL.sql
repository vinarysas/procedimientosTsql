 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    EXEC WSXML_SFG.SFG_PACKAGE_GetMonthRange @sFECHACCLO, @sFECHAFRST OUT, @sFECHALAST OUT
      ...
      WHERE PRF.FECHAARCHIVO BETWEEN CONVERT(VARCHAR,FORMAT(@sFECHAFRST, 'yyyy')+'-01-01',103) AND @sFECHALAST
        AND PRF.CODLINEADENEGOCIO = @p_CODLINEADENEGOCIO
        AND PDV.CODTIPONEGOCIO    <> 7
      GROUP BY AES.NOMALIADOESTRATEGICO, AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO, PRD.NOMPRODUCTO
      ORDER BY AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO;
 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    EXEC WSXML_SFG.SFG_PACKAGE_GetMonthRange @sFECHACCLO, @sFECHAFRST OUT, @sFECHALAST OUT
      ...
      WHERE PRF.FECHAARCHIVO BETWEEN CONVERT(VARCHAR,FORMAT(@sFECHAFRST, 'yyyy')+'-01-01',103) AND @sFECHALAST
        AND PRF.CODLINEADENEGOCIO = @p_CODLINEADENEGOCIO
        AND PRF.CODREDPDV         = WSXML_SFG.RED_F('AEL')
      GROUP BY AES.NOMALIADOESTRATEGICO, AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO, PRD.NOMPRODUCTO
      ORDER BY AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO;
  END;
GO
 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    EXEC WSXML_SFG.SFG_PACKAGE_GetMonthRange @sFECHACCLO, @sFECHAFRST OUT, @sFECHALAST OUT
      ...
      INNER JOIN WSXML_SFG.ALIADOESTRATEGICO      AES ON (AES.ID_ALIADOESTRATEGICO  = PRD.CODALIADOESTRATEGICO)
      INNER JOIN WSXML_SFG.AGRUPACIONPRODUCTO     AGP ON (AGP.ID_AGRUPACIONPRODUCTO = PRD.CODAGRUPACIONPRODUCTO)
      WHERE PRF.FECHAARCHIVO BETWEEN CONVERT(VARCHAR,FORMAT(@sFECHAFRST, 'yyyy'),103) AND @sFECHALAST
        AND PRF.CODLINEADENEGOCIO = @p_CODLINEADENEGOCIO
        AND PRF.CODREDPDV         <> WSXML_SFG.RED_F('AEL')
      GROUP BY AES.NOMALIADOESTRATEGICO, AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO, PRD.NOMPRODUCTO
      ORDER BY AGP.NOMAGRUPACIONPRODUCTO, PRD.CODIGOGTECHPRODUCTO;
