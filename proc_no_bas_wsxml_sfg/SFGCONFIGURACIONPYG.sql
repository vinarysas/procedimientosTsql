...
CREATE     PROCEDURE WSXML_SFG.SFGCONFIGURACIONPYG_SetConfiguracionCorporativa(@p_CODSERVICIO                 NUMERIC(22,0),
  ...
  BEGIN
  SET NOCOUNT ON;
    SELECT @p_ID_CONFIGURACIONPYG_out = ID_CONFIGURACIONPYG FROM WSXML_SFG.CONFIGURACIONPYG WHERE CODSERVICIO = @p_CODSERVICIO AND CODTIPOCONTRATOPRODUCTO = @p_CODTIPOCONTRATOPRODUCTO;
...
CREATE     PROCEDURE WSXML_SFG.SFGCONFIGURACIONPYG_SetAppendConfiguracionLocal(@p_CODSERVICIO                  NUMERIC(22,0),
 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    BEGIN
      SELECT @p_ID_CONFIGURACIONPYGLOCAL_out = ID_CONFIGURACIONPYGLOCAL FROM WSXML_SFG.CONFIGURACIONPYGLOCAL WHERE CODCONFIGURACIONPYG = @cCODCONFIGURACIONPYG AND CODTIPOCONTRATOPDV = @p_CODTIPOCONTRATOPDV;
