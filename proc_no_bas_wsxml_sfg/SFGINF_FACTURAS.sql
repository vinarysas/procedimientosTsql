...
CREATE     PROCEDURE WSXML_SFG.SFGINF_FACTURAS_GetInfoServiciosComerciales(@p_CODCICLOFACTURACIONPDV NUMERIC(22,0),
  ...
  SET NOCOUNT ON;
      SELECT CFP.SECUENCIA                     AS SECUENCIA,
             ...
             CONCAT(RSC.IDENTIFICACION, '-', RSC.DIGITOVERIFICACION) AS NIT,
...
CREATE PROCEDURE WSXML_SFG.SFGINF_FACTURAS_GetInfoContracts(
...
BEGIN
  ...
  SELECT CODIGOAGRUPACIONGTECH,
         ...
         CASE WHEN CONCAT(RSC.IDENTIFICACION,'-',RSC.DIGITOVERIFICACION) IS NOT NULL THEN CONCAT(RSC.IDENTIFICACION,'-',RSC.DIGITOVERIFICACION) ELSE '.' END AS NIT,
