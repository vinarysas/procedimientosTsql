USE SFGPRODU;
--  DDL for Package Body SFGWEBRUTAPDV
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGWEBRUTAPDV */ 

-- Creates a new record in the RUTAPDV table
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_AddRecord(
    @p_NOMRUTAPDV NVARCHAR(2000),
    @p_CODFMR NUMERIC(22,0),
    @p_CODUSUARIOMODIFICACION NUMERIC(22,0),
    @p_FECHAHORAMODIFICACION DATETIME,
    @p_ACTIVE NUMERIC(22,0),
    @p_NOMALTERNOFMR NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DeleteRecord(
    @pk_ID_RUTAPDV NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetRecord(
   @pk_ID_RUTAPDV NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_DrillDown(
...
-- Returns a query result from table RUTAPDV
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBRUTAPDV_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBRUTAPDV_Export(
...
SET NOCOUNT ON;
    ...
    BEGIN
        SET @l_select_str =
                ...
                ' isnull(RUTAPDV_.ACTIVE, '''') + ''' + isnull(@p_separator_str, '') + ''' +' +
                ''''' + REPLACE( isnull(RUTAPDV_.NOMALTERNOFMR, ''''), '''', '''') + ''''  + '' ''';
    END 
