USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBCUENTA
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGCONCIWEBCUENTA */ 

-- Creates a new record in the CUENTA table
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecord(
    @pk_ID_CUENTA NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetRecord(
   @pk_ID_CUENTA NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_DrillDown(
...
-- Returns a query result from table CUENTA
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCUENTA_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCUENTA_Export(
...
SET NOCOUNT ON;
    ...
    BEGIN
        SET @l_select_str =
                ...
                ''''' + REPLACE( isnull( t1.NOMTIPOCUENTA, ''''), '''', '''') + ''''  + ''' + isnull(@p_separator_str, '') + ''' +' +
    ...
    SET @l_from_str = 'WSXML_SFG.CUENTA CUENTA_ LEFT OUTER JOIN WSXML_SFG.BANCO t0 ON (CUENTA_.CODIGOBANCO =  t0.ID_BANCO) LEFT OUTER JOIN WSXML_SFG.TIPOCUENTA t1 ON (CUENTA_.CODTIPOCUENTA =  t1.ID_TIPOCUENTA) LEFT OUTER JOIN WSXML_SFG.LINEADENEGOCIO t2 ON (CUENTA_.CODLINEADENEGOCIO =  t2.ID_LINEADENEGOCIO)';
