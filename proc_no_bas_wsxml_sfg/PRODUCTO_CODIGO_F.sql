USE SFGPRODU;
--  DDL for Function PRODUCTO_CODIGO_F
--------------------------------------------------------

  IF OBJECT_ID('WSXML_SFG.PRODUCTO_CODIGO_F', 'FN') IS NOT NULL
    DROP FUNCTION WSXML_SFG.PRODUCTO_CODIGO_F;
GO

CREATE FUNCTION WSXML_SFG.PRODUCTO_CODIGO_F (@pk_ID_PRODUCTO NUMERIC(22,0)) 
