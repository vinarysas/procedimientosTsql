USE SFGPRODU;
--  DDL for Package Body SFGCONCIWEBCICLOFACTURACIONPDV
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV */ 

-- Creates a new record in the CICLOFACTURACIONPDV table
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecord(
    @pk_ID_CICLOFACTURACIONPDV NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetRecord(
   @pk_ID_CICLOFACTURACIONPDV NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_DrillDown(
...
-- Returns a query result from table CICLOFACTURACIONPDV
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGCONCIWEBCICLOFACTURACIONPDV_Export(
