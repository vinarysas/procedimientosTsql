USE SFGPRODU;
--  DDL for Package Body SFGWEBMAESTROFACTURACIONPDV
--------------------------------------------------------

  /* PACKAGE BODY WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV */ 

-- Creates a new record in the MAESTROFACTURACIONPDV table
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_AddRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_AddRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_AddRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_UpdateRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_UpdateRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_UpdateRecord(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecord(
    @pk_ID_MAESTROFACTURACIONPDV NUMERIC(22,0)
    )
AS
BEGIN
...
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecords', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecords;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DeleteRecords(
...
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetRecord', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetRecord;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetRecord(
   @pk_ID_MAESTROFACTURACIONPDV NUMERIC(22,0)
...
--    1) count is 0 ;
--    2) empty resultset.
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetList', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetList;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetList(
...
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DrillDown', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DrillDown;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_DrillDown(
...
-- Returns a query result from table MAESTROFACTURACIONPDV
-- given the search criteria and sorting condition.
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetStats', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetStats;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_GetStats(
    @p_select_str NVARCHAR(2000),
    @p_join_str NVARCHAR(2000),
    @p_where_str NVARCHAR(2000),
    @p_sort_str NVARCHAR(2000),
...
IF OBJECT_ID('WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_Export', 'P') IS NOT NULL
  DROP PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_Export;
GO

CREATE PROCEDURE WSXML_SFG.SFGWEBMAESTROFACTURACIONPDV_Export(
