...
CREATE     PROCEDURE WSXML_SFG.SFGREPORTE_QueueSingleReportMail(@p_CODCICLOFACTURACIONPDV NUMERIC(22,0), @p_LLAVECORREO NVARCHAR(2000), @p_COUNTREPORTS_out NUMERIC(22,0) OUT) AS
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    FROM WSXML_SFG.REPORTECORREO WHERE LLAVECORREO = @p_LLAVECORREO;
     ...
     SELECT RCA.CODREPORTECORREO, RPT.NOMREPORTE,
                         ...
                         LEFT OUTER JOIN WSXML_SFG.REPORTEGENERADO RGD ON (RGD.CODCICLOFACTURACIONPDV = @p_CODCICLOFACTURACIONPDV
                                                             AND RGD.CODREPORTE             = RCA.CODREPORTE)
                         WHERE RCA.CODREPORTECORREO = @cCODREPORTECORREO
                           AND RCA.ACTIVE = 1; OPEN attachment;
END
GO
