 ...
 BEGIN
  ...
  SET NOCOUNT ON;
    ...
    IF @xPLANTILLAPRODUCTO IS NOT NULL BEGIN
				...
				BEGIN
					...
					IF @@ROWCOUNT = 0 BEGIN
						...
						INSERT INTO @p_cur_ADVANCEDLISTCOMMISSIONS VALUES (
								@_INDEX,@defaultCODRANGOCOMISION,@defaultCODTIPOCOMISION,@defaultCOMISIONANTICIPO,@defaultVALORPORCENTUAL,@defaultVALORTRANSACCIONAL);	
						SET @_INDEX = @_INDEX + 1
					END ELSE BEGIN
					   ...
					   WHERE ID_RANGOCOMISION = @thisRANGOCOMISION;
						...
						IF @@ROWCOUNT > 1 BEGIN
							...
							SET @flag = 1
							INSERT INTO @p_cur_ADVANCEDLISTCOMMISSIONS VALUES (
									@_INDEX, @thisRANGOCOMISION, @defaultCODTIPOCOMISION, @defaultCOMISIONANTICIPO,@defaultVALORPORCENTUAL, @defaultVALORTRANSACCIONAL);
							SET @_INDEX = @_INDEX + 1
      ...
      END
      ELSE BEGIN
        RAISERROR('-20054 No existe información de comisiones avanzadas en el sistema. No se puede solicitar la información', 16, 1);
		RETURN 0
      END 
    END 
				...
				*/
				...
				BEGIN
					...
					END ELSE BEGIN
						...
						WHERE ID_PLANTILLAPRODUCTODETALLEAVA = @xCODPLANTILLAPRODUCTODETALLEAV;
					END
    ...
    DECLARE UI CURSOR FOR 
		...
		BEGIN
			...
			(--T.ID_PLANTILLAPRODUCTODETALLEAVA,
				 CODPLANTILLAPRODUCTODETALLE, CODTIPOTRANSAVANZADO, CODRANGOCOMISION)
			SELECT --WSXML_SFG.PLANTILLAPRODUCTODETALLEAV_SEQ.NEXTVAL,
				 @LP2_ID_PLANTILLAPRODUCTODETALLE, 1, 73
